...
function updateTree(){$(".tree-branch-name > .checkbox > input[name='folder']").each(function(){
    var statuses = [];
    ...
    if(statuses.length !== 0){
        var allfileschecked = statuses.reduce(function(a,b){return a & b});
        var partfilechecked = statuses.reduce(function(a,b){return a | b});
