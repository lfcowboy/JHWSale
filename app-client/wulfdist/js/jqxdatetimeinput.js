...
(function ($) {
    ...
    $.extend($.jqx._jqxDateTimeInput.prototype, {
            ...
            if (this.calendarContainer != null) {
                this.addHandler(this.calendarContainer, 'keydown', function (event) {
                    ...
                    if (event.keyCode == 115) {
                        if (me.isOpened()) {
                            me.hideCalendar("keyboard");
                            me.dateTimeInput.focus();
                            return false;
                        }
                        else if (!me.isOpened()) {
                            me.showCalendar("keyboard");
                            me.dateTimeInput.focus();
                            return false;
                        }
                    }
        ...
        {
            this.timePopupElement = $("<div style='border-style: solid; border-width: 1px;'></div>").appendTo(this.timeContainer);
