...
window.Charts = 
{
    ...
    create: function (options, chart_options, callback)
    {
        ...
        {
            chart_options.chart.plotBackgroundImage = './wulfdist/img/plot-background.png'
        }
                    ...
                    point: {
                        events: {
                            ...
                            mouseOut: function ()
                            {
                                ...
                                for (var n in bar_outlines)
                                {
                                    bar_outlines[n][0].attr('visibility', 'hidden')
                                    bar_outlines[n][1].attr('visibility', 'hidden')
                                }
